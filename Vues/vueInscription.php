			...
			<td>
				...
				<fieldset>
					...
					<div class="form registration">
						<form id="register" autocomplete="off" method="post" name="login" action="<?php echo ABSOLUTE_ROOT . '/controleurs/ControleurUser.php?action=validerInscription'; ?>">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<br></br>
									<a href="<?php echo ABSOLUTE_ROOT . '/controleurs/ControleurUser.php?action=connexion'; ?>">

										Deja membre? Connectez vous ici
...
<script>
	$(document).ready(function(){
		...
		$("#pass2").keyup(function(){  // si activité dans le champs input pass2 alors :
			...
			{
				$("#checkpass2").css("color","red").html("Mot de passe Trop Court (6 Caracteres requis)");
			}
			...
			else // on traite l'inscription avec AJAX
			{
				$.ajax({
					...
					success:function(result){
						if($.trim(result) != "RegisterSuccess"){
						...
						else
						{
							...
							$("#bloc_global").replaceWith('<?php $this->titre = "Inscription Terminee"; ?><div id="bloc_contents"><p style="text-align:center;color:red"> Vous venez d\'effectuer votre inscription sur Sondagax<br/>Un lien d\'activation de votre vient de vous etre envoyer</p></div>');
						}
					},
