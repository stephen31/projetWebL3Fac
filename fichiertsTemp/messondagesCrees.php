	...
	<section id="contenu">
		<div id="bloc_principal">
			...
			<div id="bloc_contents">
				<h3> MES SONDAGES CREES</h3>
				<div class="sondage">
					<h4> Sondage experimental</h4>
					<span class="sondage_auteur"> creeé par <span class="nom_auteur">Mathieu Martinez</span></span>
					<span class="sondage_heure"> il y a 21 heures </span>
					<div class="sondage_nb_coms">12 commantaires</div>
					<div class="desc_sondage">
						ossède une distribution de lettres plus ou moins normale, 
						et en tout cas comparable avec celle du français standard.
						De nombreuses suites logicielles de mise en p
