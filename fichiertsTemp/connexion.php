								...
								<div class="form registration">
									<form name="login" action="#" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input id="username" type="text" value="" required="required" autocomplete="off" placeholder="Email" name="email"></input>
												<span class="inline-message"></span>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input id="password" type="password" required="required" placeholder="Password" name="password"></input>
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
