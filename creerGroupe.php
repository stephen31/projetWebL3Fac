					...
					<tr>
						...
						<td>
							...
							<fieldset>
								...
								<div class="form registration">
									<form id="groupe_add" autocomplete="off" name="nomGroupe" action="#" method="post">
										<div class="control-group">
											<label class="control-label" for="nomGroupe">
											...
											<div class="controls">
												<input id="newgroupe" class="input-error" type="text" autocomplete="off" maxlength="20" value="" placeholder="Nom du groupe" name="nomGroupe" required="required"></input>
												<br></br>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input id="register" class="btn2" type="submit" value="Ajouter Groupe"></input>
											</div>
